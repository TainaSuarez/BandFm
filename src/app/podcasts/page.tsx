  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <footer className="bg-white text-black py-12">
        <div className="max-w-full mx-auto px-6 sm:px-8 lg:px-12 grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/podcasts" className="text-gray-400 hover:text-bandfm-orange-500">Podcasts</Link></li>
