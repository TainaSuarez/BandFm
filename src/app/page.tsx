          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {promocoes.length > 0 ? (
              promocoes.slice(0, 2).map((promocao) => (
                <div key={promocao.id} className="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-all duration-300 border border-gray-200">
                  {promocao.imagem && (
                  ...
                  <div className="p-6">
                    ...
                    <Link 
                      href="/promocoes"
                      className="inline-flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-bandfm-orange-500 to-orange-600 hover:from-bandfm-orange-600 hover:to-orange-700 text-white font-bold rounded-lg transition-all duration-300 transform hover:scale-105 shadow-md hover:shadow-lg group"
                    >
                      Saber Mais
